...
Research is the classic subagent use case. Consider investigating how authentication works in an unfamiliar codebase. Your main thread needs to know _where_ the JWT is validated, but it doesn't need to see every file that was searched along the way.
